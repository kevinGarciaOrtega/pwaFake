...
export default function LoginPage({ onLogin }: LoginPageProps) {
  ...
  const handleIngresar = (e: React.FormEvent) => {
    e.preventDefault()
    setError('')
    if (documento === CREDENCIALES.usuario && clave === CREDENCIALES.clave) {
  ...
  return (
    <div className="app-container">
      ...
      <header className="login-header">
        ...
        <h1 className="logo">
          <span className="logo-bif">Bif</span>
      ...
      {/* ── Área scrollable (hero + form) ───────────────────── */}
      <div className="login-scroll">

        {/* Hero Image */}
        <div className="hero-wrapper">
          <img src={heroImg} alt="Bienvenido a Bif" className="hero-img" />
        ...
        <main className="login-card">
          <form onSubmit={handleIngresar} noValidate>
            ...
            <div className="input-group">
              ...
              />
              <button type="button" className="toggle-password" onClick={() => setMostrarClave(!mostrarClave)} aria-label={mostrarClave ? 'Ocultar clave' : 'Mostrar clave'}>
                {mostrarClave ? (
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      ...
      <nav className="bottom-nav" aria-label="Accesos rápidos">
        ...
        <button className="nav-item">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
            <circle cx="12" cy="12" r="9" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l2.5 2.5" />
          </svg>
          <span>Plin</span>
        </button>
        <button className="nav-item">
